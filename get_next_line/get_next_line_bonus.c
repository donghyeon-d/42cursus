...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/29 08:57:38 by dongchoi          #+#    #+#             */
/*   Updated: 2022/03/30 12:04:56 by dongchoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_lstsplit(t_list *fd_text)
{
	...
	if (str[i] == '\n')
	{
		ft_lstadd_back(&fd_text, ft_lstnew(ft_strldup(str, i + 1)));
	...
	{
		ft_lstadd_back(&fd_text, ft_lstnew(ft_strldup(str, len)));
